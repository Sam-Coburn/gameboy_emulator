...
//     instruct.target_8bit = Operand8::B;
...
//         instruct.target_8bit = Operand8::A;
...
//         instruct.target_8bit = Operand8::C;
...
//         instruct.target_8bit = Operand8::D;
...
//         instruct.target_8bit = Operand8::E;
...
//         instruct.target_8bit = Operand8::H;
...
//         instruct.target_8bit = Operand8::L;
...
//         instruct.target_8bit = Operand8::HL_PTR;
...
//         c.registers.a = 1;
//         instruct.target_8bit = Operand8::NUM;
...
//         CPU c;
//         instruct.target_16bit = Operand16::BC;
...
//     SECTION ("ADDHL - DE") {
//         CPU c;
//         instruct.target_16bit = Operand16::DE;
...
//     SECTION ("ADDHL - HL") {
//         CPU c;
//         instruct.target_16bit = Operand16::HL;
...
//     SECTION ("ADDHL - SP") {
//         CPU c;
//         instruct.target_16bit = Operand16::SP;
...
//         REQUIRE(instruct.target_8bit == Operand8::A);
//     }
...
//         REQUIRE(instruct.type == InstructionType::SWAP);
//         REQUIRE(instruct.target_8bit == Operand8::HL_PTR);
//     }
